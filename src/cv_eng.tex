...
\usepackage[T2A,T1]{fontenc}   % T2A для кириллицы (cm-super), T1 для латиницы
...
\newcounter{expyears}
\setcounter{expyears}{\year}
\addtocounter{expyears}{-2007}

\usepackage{enumitem}
\newlist{tabitemize}{itemize}{1}
\setlist[itemize]{nosep, leftmargin=*}
\setlist[tabitemize]{nosep, leftmargin=1.5em, label=\labelitemi, after={\vspace{-\baselineskip}}}
...
\begin{document}	
	...
	\noindent {\textbf{Profile:}} Team Lead/Data Techlead/Senior Data Scientist (DL, CV). \href{https://disk.yandex.ru/i/ffl8gXNlYxGT8g}{PhD in engineering}. General work experience as a research programmer -- \theexpyears{} years.\\
