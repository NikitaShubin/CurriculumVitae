...
\typeout{=== DEBUG: textheight=\the\textheight, textwidth=\the\textwidth ===}
\typeout{=== DEBUG: vsize=\the\vsize, hsize=\the\hsize ===}
...
\begin{document}
	\typeout{=== DEBUG: at begin document ===}
	\typeout{=== DEBUG: fontenc = \f@encoding ===}
	\typeout{=== DEBUG: fontfamily = \f@family ===}
	\typeout{=== DEBUG: baselineskip = \the\baselineskip ===}
