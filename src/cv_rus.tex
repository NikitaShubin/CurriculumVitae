...
\begin{document}
	...
	\begin{tabular}{p{0.19\textwidth} p{0.78\textwidth}}
		{\centering
			\raisebox{-\totalheight}{
				\begin{tikzpicture}
					\clip (0,0) circle (2cm);
					\node[anchor=center] at (0,0) {\includegraphics[width=4.3cm]{ava}};
	...
	%\vspace{0.5em}
		...
		\begin{tabular} {r|p{0.863\textwidth}}
			...
			\noindent{Достижения} & 
			\begin{itemize}
			\item Выстроил конвейер обработки видеоданных, организовал команду разметки и разработал ПО для ускорения разметки в \href{https://www.cvat.ai/}{CVAT} с помощью Segment Anything Model \href{https://segment-anything.com/}{v1} и \href{https://sam2.metademolab.com/demo}{v2}. Основные результаты изложены на \href{https://rutube.ru/video/4033ea0473199564892cc5a2f14dcfe6/}{D-Vision-митапе}.
			\item Обучил модели, решающие поставленные задачи.
			\end{itemize}
\typeout{=== DEBUG-RUS-1: prevdepth=\the\prevdepth, baselineskip=\the\baselineskip, parskip=\the\parskip ===}
		\end{tabular}
		...
		\begin{tabular} {r | p{0.863\textwidth}}
			...
			\end{itemize}
\typeout{=== DEBUG-RUS-2: prevdepth=\the\prevdepth, baselineskip=\the\baselineskip, parskip=\the\parskip ===}
		\end{tabular}
		\vspace{0.3em}\hrule\vspace{0.1em}\hrule\vspace{0.5em}
		...
		\begin{tabular} {r | p{0.863\textwidth}}
			...
			\end{itemize}
\typeout{=== DEBUG-RUS-3: prevdepth=\the\prevdepth, baselineskip=\the\baselineskip, parskip=\the\parskip ===}
		\end{tabular}
		\vspace{0.3em}\hrule\vspace{0.1em}\hrule\vspace{0.5em}
		...
		\begin{tabular} {r | p{0.863\textwidth}}
			...
			\end{itemize}
\typeout{=== DEBUG-RUS-4: prevdepth=\the\prevdepth, baselineskip=\the\baselineskip, parskip=\the\parskip ===}
			\\
			Достижения &
		...
		\begin{tabular} {r | p{0.863\textwidth}}
			...
			\end{itemize}
\typeout{=== DEBUG-RUS-5: prevdepth=\the\prevdepth, baselineskip=\the\baselineskip, parskip=\the\parskip ===}
			\\
			Достижения &
			\begin{itemize}
			...
			\end{itemize}
\typeout{=== DEBUG-RUS-6: prevdepth=\the\prevdepth, baselineskip=\the\baselineskip, parskip=\the\parskip ===}
		\end{tabular}
